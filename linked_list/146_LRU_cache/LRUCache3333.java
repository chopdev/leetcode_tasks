...
/**
 ...
 One particularity about the double linked list that I implemented is that I create a pseudo head and tail to mark
 the boundary, so that we don't need to check the NULL node during the update. This makes the code more concise and
 clean, and also it is good for the performance as well.


 */
public class LRUCache3333 {
    class DLinkedNode {
        int key;
        int value;
        DLinkedNode pre;
    ...
    public LRUCache3333(int capacity) {
        this.count = 0;
