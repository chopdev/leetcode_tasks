/**
 ...
 1) should be array be sorted after removing of duplicates?
...
public class Solution {
    ...
    // i - last index of correct array
    // while nums[i] == nums[j] - we have a duplicate sequence
    // when we encounter other value, we copy it to next i value: i+1
